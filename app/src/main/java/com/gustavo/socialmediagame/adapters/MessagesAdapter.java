...
public class MessagesAdapter extends FirestoreRecyclerAdapter<Message, MessagesAdapter.ViewHolder> {
   ...
   AuthProvider mAuthProvider;
    ...
    protected void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position, @NonNull @NotNull Message model) {
        ...
        String relativeTime = RelativeTime.timeFormatAMPM(model.getTimestamp(), context);
        ...
        if (model.isVieweb()){
            holder.imageViewVieweb.setImageResource(R.drawable.icon_check_blue);
        } else {
            holder.imageViewVieweb.setImageResource(R.drawable.icon_check_gray);
        }
